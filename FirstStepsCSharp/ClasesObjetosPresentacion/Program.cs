...
Console.WriteLine("---------------------------------------- EJEMPLO ATRIBUTOS PRIVADOS ----------------------------------------\n");
Coche.Main(args);
Estudiante.Main(args);
Videojuego.Main(args);

/* MAIN DE LOS EJEMPLOS DE ATRIBUTOS PUBLICOS */
Console.WriteLine("---------------------------------------- EJEMPLO ATRIBUTOS PUBLICOS ----------------------------------------\n");
CarMain.Main(args);
