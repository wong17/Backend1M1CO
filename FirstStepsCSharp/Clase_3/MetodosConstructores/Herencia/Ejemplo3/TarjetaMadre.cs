namespace MetodosConstructoresHerencia.Herencia.Ejemplo3
{
     ...
     */
    public class TarjetaMadre : Componente
    {
        /* Atributos propios de la clase TarjetaMadre */
        private bool lucesRGB;
        /* 
         * Constructor de la clase TarjetaMadre 
         * 
         ...
         */
        public TarjetaMadre(string nombre, double precio, string fabricante, bool lucesRGB)
            : base(nombre, precio, fabricante)
        {
            LucesRGB = lucesRGB;
        }
        /* Propiedades getters y setters */
        public bool LucesRGB { get => lucesRGB; set => lucesRGB = value; }
    }
}
